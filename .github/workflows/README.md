...
- HOST_DOMAIN - Domain/sub-domain of your application, eg `vanilla-on-ecr.example.com` .
...
gh secret set AWS_ECS_CLUSTER -b"<AWS_ECS_CLUSTER, eg vanilla-on-ecrs>"
gh secret set HOST_DOMAIN -b"<HOST_DOMAIN, eg vanilla-on-ecr.example.com>"
